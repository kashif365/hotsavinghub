...
<div class="container mt-4">
    <div class="card">
        <div class="card-header">
            <h4 class="mb-0">Add New Home Content Block</h4>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.home-content-blocks.store') }}" method="POST">
                @csrf

                <div class="mb-3">
                    <label for="title" class="form-label">Title (admin reference only, not shown on the site)</label>
                    <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" maxlength="255" placeholder="e.g. Buying Guide, FAQ, About this page...">
                    @error('title')
                ...
                <div class="mb-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="full-editor" class="form-control">{!! old('content') !!}</div>
                ...
                <div class="mb-3">
                    <button type="submit" class="btn btn-primary">Create Content Block</button>
