...
<div class="container mt-4">
    <div class="card">
        <div class="card-header">
            <h4 class="mb-0">Add New Spotlight Card</h4>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.spotlight-cards.store') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Card Image / Photo <span class="text-danger">*</span></label>
                        <div class="image-upload-box" onclick="document.getElementById('image').click()">
                            <img id="image_preview" style="display:none;">
                            <svg id="image_placeholder" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        ...
                        @enderror
                        <small class="form-text text-muted d-block mt-2">Required. Max 2MB. Used as the card's photo/background.</small>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        @error('logo')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                        <small class="form-text text-muted d-block mt-2">Optional small brand logo shown on the card.</small>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('heading') is-invalid @enderror" id="heading" name="heading" value="{{ old('heading') }}" maxlength="255" placeholder="e.g. Shop Summer Essentials for Up to 77% Off">
                        @error('heading')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('cta_label') is-invalid @enderror" id="cta_label" name="cta_label" value="{{ old('cta_label') }}" maxlength="255" placeholder="e.g. SHOP NOW">
                        @error('cta_label')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="color-input-group">
                            <div class="input-group">
                                <input type="color" class="form-control form-control-color" id="bg_color" name="bg_color" value="{{ old('bg_color', '#0f172a') }}">
                                <input type="text" class="form-control color-text-input" value="{{ old('bg_color', '#0f172a') }}" readonly>
                            </div>
                        </div>
                ...
                <div class="mb-3">
                    <button type="submit" class="btn btn-primary">Create Spotlight Card</button>
