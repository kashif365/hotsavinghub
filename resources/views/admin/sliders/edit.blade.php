            ...
            <form action="{{ route('admin.sliders.update', $slider) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <div class="image-upload-box" onclick="document.getElementById('background_image').click()">
                        ...
                        <svg id="slider_image_placeholder" style="{{ $slider->background_image ? 'display:none;' : '' }}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    @enderror
                    <small class="form-text text-muted d-block mt-2">Leave empty to keep current image. Upload or pick from Media Library to replace (Max: 2MB)</small>
                </div>
