            ...
            <form action="{{ route('admin.sliders.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Main Image (right, ~52% width) <span class="text-danger">*</span></label>
                        <div class="image-upload-box" onclick="document.getElementById('background_image').click()">
                            <img id="background_image_preview" style="display:none;">
                            <svg id="background_image_placeholder" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        ...
                        @enderror
                        <small class="form-text text-muted d-block mt-2">Required. Max 2MB.</small>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="image-upload-box" onclick="document.getElementById('secondary_image').click()">
                            <img id="secondary_image_preview" style="display:none;">
                            <svg id="secondary_image_placeholder" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                <path d="M20,5A2,2 0 0,1 22,7V17A2,2 0 0,1 20,19H4C2.89,19 2,18.1 2,17V7C2,5.89 2.89,5 4,5H20M5,16H19L14.5,10L11,14.5L8.5,11.5L5,16Z" />
                            </svg>
                        </div>
                        <div class="d-flex gap-2 mt-2 flex-wrap">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('label') is-invalid @enderror" id="label" name="label" value="{{ old('label') }}" maxlength="255" placeholder="e.g. LIMITED TIME">
                        @error('label')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('heading') is-invalid @enderror" id="heading" name="heading" value="{{ old('heading') }}" maxlength="255" placeholder="e.g. Up to 50% Off Everything">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('subtitle') is-invalid @enderror" id="subtitle" name="subtitle" value="{{ old('subtitle') }}" maxlength="255" placeholder="e.g. at Nike">
                        @error('subtitle')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('cta_text') is-invalid @enderror" id="cta_text" name="cta_text" value="{{ old('cta_text') }}" maxlength="255" placeholder="Shop Now">
                        @error('cta_text')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('cta_url') is-invalid @enderror" id="cta_url" name="cta_url" value="{{ old('cta_url') }}" maxlength="2048" placeholder="https://... or /category/...">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="color-input-group">
                            <div class="input-group">
                                <input type="color" class="form-control form-control-color" id="badge_color" name="badge_color" value="{{ old('badge_color', '#2951c4') }}">
                                <input type="text" class="form-control color-text-input" value="{{ old('badge_color', '#2951c4') }}" readonly>
                            </div>
                        </div>
